...
use crate::admDataOld::AdmDataOld;

pub struct AdmGraphOld {
    l: VertexSet,
    checks: VertexSet,
    pub candidates: VertexSet,
    adm_data: VertexMap<AdmDataOld>,
}
...
impl AdmGraphOld {
    pub fn new(graph: &EditGraph) -> Self {
        ...
        for u in graph.vertices() {
            let adm_vertex = AdmDataOld::new(*u, graph.neighbours(u).copied().collect());
    ...
    fn store_vias(&mut self, p: usize, v: &mut AdmDataOld) {
        let p1 = v.p1.clone();
        v.delete_packing();
    ...
    fn get_t2_vertices(&self, v: &AdmDataOld) -> VertexSet {
    ...
    fn get_t3_vertices(&self, v: &AdmDataOld) -> VertexSet {
    ...
    fn update_t1_of_v(&mut self, v:&AdmDataOld, u: &mut AdmDataOld) {
        u.t1.remove(&v.id);
    ...
    fn update_t2_of_v(&mut self, v:&Vertex, u: &mut AdmDataOld) {
    ...
    fn update_t3_of_v(&mut self, v:&Vertex, u: &mut AdmDataOld) {
    ...
    fn do_maximal_check(&mut self, p: usize, v:&mut AdmDataOld) -> bool{
        v.delete_packing();
    ...
    fn do_maximum_check(&mut self, p: usize, v:&mut AdmDataOld){
    ...
    fn update_v(&mut self, p: usize, v:&mut AdmDataOld) {
